...
var scorethirdPlayer= heights_thirdplayer + (5* age_thirdPlayer);
 if (scoreFisrtPlayer > scoresecondPlayer && scoreFisrtPlayer > scorethirdPlayer)
 {
     console.log('The winner is'  + firstPlayer + 'with' + scoreFisrtPlaye + 'score' );

 }

 else if  (scoresecondPlayer > scoreFisrtPlayer && scoresecondPlayer > scorethirdPlayer)
 {
     console.log('The winner is'  + secondPlayer + 'with' + scoresecondPlayer + 'score ');
  } 
   else if (scorethirdPlayer >scoreFisrtPlayer && scorethirdPlayer > scorethirdPlayer)
   {
    console.log('The winner is'  + thirdplayer + 'with' + scorethirdPlayer + 'score ');
   }
